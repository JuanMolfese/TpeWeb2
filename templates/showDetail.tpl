...
<main class="container">
    ...
    <h4 class='my-4 ml-4 text-secondary'></h4>
    
    <div class='d-flex row my-4 mx-4'>

        <div class='form-group pt-6 col-md-7 p-0'>
            <label class="font-weight-bold" for='input_product_name'>Nombre del producto</label>
            <input type='text' value="{$product->nombre}" class='form-control bg-transparent border-0 font-weight-bold' id='input_product_name' readonly>
        </div>
